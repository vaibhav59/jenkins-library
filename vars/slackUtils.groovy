...
if (true) {
  ...
  slackSend baseUrl: "https://${args.team}.slack.com/services/hooks/jenkins-ci/" , color: 'good' , message: "Success: Job", channel: "${args.channel}", teamDomain: 'mypersonalspace-555', tokenCredentialId: 'slackToken'
