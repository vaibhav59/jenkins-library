...
if (true) {
  ...
  slackSend (baseUrl: "https://${args.team}.slack.com/services/hooks/jenkins-ci/" , color: 'good' , message: "Done", channel: "${args.channel}", teamDomain: "${args.team}", tokenCredentialId: "${args.credentials}")
