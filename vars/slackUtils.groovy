...
if (true) {
  ...
  slackSend (baseUrl: "https://${args.team}.slack.com/services/hooks/jenkins-ci/" , color: 'good' , message: "SUCCESS: Job '${env.JOB_NAME} [${env.BUILD_NUMBER}]' (${env.BUILD_URL})", channel: "${args.channel}", teamDomain: "'${args.team}'", tokenCredentialId: "'${args.credentials}'")
