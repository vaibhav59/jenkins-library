...
if (true) {
  ...
  slackSend (baseUrl: "https://${args.team}.slack.com/services/hooks/jenkins-ci/" , color: colorCode , message: details, channel: "${args.channel}", teamDomain: "'${args.team}'", tokenCredentialId:  "'${args.credentials}'")
