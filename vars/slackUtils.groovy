...
if (true) {
  ...
  slackSend (baseUrl: "https://${args.team}.slack.com/services/hooks/jenkins-ci/" , color: 'good' , message: details, channel: "${args.channel}", teamDomain: 'mypersonalspace-555', tokenCredentialId: 'slackToken')
